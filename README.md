<h1 align="center">👋 Hi there, I'm Marcos Vinicius Thibes Kemer</h1>

<p align="center">
  <strong>Python Developer | Backend | Linux | Docker | GitHub | Clean Code</strong>
</p>
...
<p align="center">
  🐧 Working daily inside <strong>Ubuntu Terminal</strong> using <strong>Neovim</strong>, <strong>Docker</strong>, and <strong>Git</strong>.<br>
  💡 Always exploring new ways to make backend systems more efficient.<br>
  ☕ “Clean code and coffee — that’s how good software is brewed.”
</p>
...
<span style="color:#33ff33;">mirco@Mirco</span>:<span style="color:#00ffff;">~</span>$ <span style="color:#ffffff;">cat about_me.txt</span>
</pre>

- 👨🏻‍💻 Focused on **automation, backend & desktop applications**  
...
- 👨‍👩‍👧‍👧 Family always comes first — my greatest inspiration 💙  
...
<pre style="background-color:#0d1117; color:#c9d1d9; padding:12px; border-radius:8px;">
<span style="color:#33ff33;">mirco@Mirco</span>:<span style="color:#00ffff;">~</span>$ <span style="color:#ffffff;">apt list --installed | grep 'dev-tools'</span>
</pre>
...
<pre style="background-color:#0d1117; color:#c9d1d9; padding:12px; border-radius:8px;">
<span style="color:#33ff33;">mirco@Mirco</span>:<span style="color:#00ffff;">~</span>$ <span style="color:#ffffff;">./run backend_analysis.py --stack python docker linux fastapi</span>
</pre>

<p align="center">
  <img src="https://skillicons.dev/icons?i=python,docker,linux,git,github,vscode,fastapi,postgresql,sqlite&theme=dark" /><br><br>
</p>
...
<pre style="background-color:#0d1117; color:#c9d1d9; padding:12px; border-radius:8px;">
<span style="color:#33ff33;">mirco@Mirco</span>:<span style="color:#00ffff;">~</span>$ <span style="color:#ffffff;">top --stats languages</span>
</pre>
...
<pre style="background-color:#0d1117; color:#c9d1d9; padding:12px; border-radius:8px;">
<span style="color:#33ff33;">mirco@Mirco</span>:<span style="color:#00ffff;">~</span>$ <span style="color:#ffffff;">ls ~/projects/mircothibes</span>
</pre>

- 🧰 **[sysinfo-cli](https://github.com/mircothibes/sysinfo-cli)** – System info tool built in Python CLI with Docker  
- ⚡ **[fast-crud](https://github.com/mircothibes/fast-crud)** – FastAPI + PostgreSQL CRUD microservice with Docker Compose  
- 💰 **[personal-finance-tracker](https://github.com/mircothibes/personal-finance-tracker)** – Personal finance tracker app with GUI and database integration  
...
<pre style="background-color:#0d1117; color:#c9d1d9; padding:12px; border-radius:8px;">
<span style="color:#33ff33;">mirco@Mirco</span>:<span style="color:#00ffff;">~</span>$ <span style="color:#ffffff;">ping -c 3 social_networks</span>
</pre>
...
<pre style="background-color:#0d1117; color:#c9d1d9; padding:12px; border-radius:8px;">
<span style="color:#33ff33;">mirco@Mirco</span>:<span style="color:#00ffff;">~</span>$ <span style="color:#ffffff;">sudo apt install coffee && echo "Coding with caffeine is always better."</span>
</pre>
