...
│                                                                      │
│  mirco@linux  ~  $  echo "$STACK"                                    │
│  Python • Linux (Ubuntu/WSL) • Docker • FastAPI • PostgreSQL • Git   │
╰──────────────────────────────────────────────────────────────────────╯
```
<p align="center"> <i>Building backend systems and automation tools with a Linux mindset.</i> </p>
